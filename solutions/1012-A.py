...
Tags: bruteforce,implementation,math,sortings,*1500
'''
...
def find_minimal_area(n, coordinates):
    ...
    # Calculate width and height of the minimal rectangle
    width = coordinates[n-1] - coordinates[0]
    height = coordinates[2*n-1] - coordinates[n]
    
    # Calculate the minimal area
    minimal_area = width * height
    return minimal_area

# Sample test case
n = 4
coordinates = [1, 1, 2, 2, 3, 3, 3, 4]
expected_result = 1

# Call the solution function
result = find_minimal_area(n, coordinates)
